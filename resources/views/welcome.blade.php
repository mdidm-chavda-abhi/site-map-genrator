...
<body class="dark-scheme">
                ...
                <div class="container">
                    <div class="sm-hide border-white-op-3 p-40 py-4 rounded-1 bg-blur relative overflow-hidden wow fadeInUp">
                        ...
                        <div class="row g-4 justify-content-between align-items-center relative z-2">
                            ...
                            <!-- Left Section -->
                            <div class="col-lg-6">
                                <h2 class="mb-0">Generate Sitemap</h2>
                                <h4 class="mb-0">Enter Your Domain Below</h4>
                            </div>

                           <!-- Middle Section: Form -->
                            <div class="col-lg-6">
                                <form id="sitemapForm" action="{{route('generate.sitemap')}}" method="POST" class="d-flex w-100">
                                    @csrf
                                    <input type="text" name="domain" class="form-control me-2" placeholder="https://example.com" required>
                                    <button type="submit" id="submitBtn" class="btn-main mx-2 fx-slide">
                                        Generate
                                    </button>
                                </form>
                            </div>
    ...
    <!-- Add this inside your Blade or layout -->
<script>
